...
RUN DEEPEP_COMMIT=9af0e0d0e74f3577af1979c9b9e1ac2cad0104ee /install-scripts/deepep.sh \
    ...
    && VLLM_REPO_URL=https://github.com/neuralmagic/vllm.git VLLM_BRANCH=imarkov/dp_startup_fix VLLM_USE_PRECOMPILED=0 MAX_JOBS=$(( "$(nproc)" * 3 / 4 )) /install-scripts/vllm.sh
